...
// Define the UISuggestion interface to match the schema and ./lib/editor/suggestions.tsx
export interface UISuggestion {
  ...
  description: string | null; // Updated to allow null, matching schema
  isResolved: boolean;
  userId: string;
  createdAt: Date;
    ...
    <AnimatePresence>
      {!isExpanded ? (
        ...
        >
          ...
          <div>{suggestion.description ?? 'No description available'}</div> {/* Handle null case */}
          <Button
            variant="outline"
