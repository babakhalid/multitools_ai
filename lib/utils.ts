...
import { Book, Globe, Newspaper, Users, Mountain, YoutubeIcon } from 'lucide-react'; // Import icons

import type { Message as DBMessage, Document } from '@/lib/db/schema';
import { ChatsCircle, Code, Memory, XLogo } from '@phosphor-icons/react'


// Define SearchGroup interface with icon and show
...
export function convertToUIMessages(messages: Array<DBMessage>): Array<Message> {
  return messages.reduce((chatMessages: Array<Message>, message) => {
    if (message.role === 'tool') {
      return addToolMessageToChat({ toolMessage: message as CoreToolMessage, messages: chatMessages });
    }
